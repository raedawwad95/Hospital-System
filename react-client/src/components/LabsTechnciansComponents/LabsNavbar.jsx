...
class LabsNavbar extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      auth: false,
            ...
            {auth && (
              <div>
                ...
                >                    
                  ...
                  <MenuItem onClick={this.handleClose} component={Link} to="/labTech/logout">Logout</MenuItem>
                </Menu>
              </div>
            )}
            {!auth && (
...
LabsNavbar.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(LabsNavbar);